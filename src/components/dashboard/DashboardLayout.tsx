  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <aside
        className={`${
          collapsed ? "w-16" : "w-64"
        } bg-sidebar border-r border-sidebar-border flex-col transition-all duration-300 hidden lg:flex`}
      >
        <SidebarContent />
      </aside>
        ...
        <header className="h-14 lg:h-16 bg-card border-b border-border flex items-center justify-between px-4 lg:px-6">
          <div className="flex items-center gap-3 lg:gap-4">
            ...
            <div className="relative hidden sm:block">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 bg-muted rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 w-48 lg:w-64"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <div className="flex items-center gap-2 lg:gap-3 pl-2 lg:pl-4 border-l border-border">
              ...
              <div className="w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-gradient-primary flex items-center justify-center text-primary-foreground font-semibold text-sm">
